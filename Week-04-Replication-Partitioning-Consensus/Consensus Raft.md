...
## Ops Sim: Northstar Kubernetes Control Plane Election Storm

**Drill note:** Answer from the incident timeline below. Tie every mitigation to Raft leadership, quorum, fsync, and Kubernetes eviction evidence.
