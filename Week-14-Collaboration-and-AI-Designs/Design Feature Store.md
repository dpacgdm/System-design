...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **1. Throughput (RPS)** | Feature Reads / Materializations | 25K Online R / 5K Mat /s | 125K Online R / 25K Mat /s | — | — |
| **2. Bandwidth (Network)** | Ingress / Egress Traffic | 10 MB/s In / 50 MB/s Out | 50 MB/s In / 250 MB/s Out | — | — |
| **3. RAM Working Set** | Online Feature Cache RAM | 50 GB Redis RAM | 100 GB Headroom RAM | — | — |
| **4. Storage Footprint** | Offline Parquet + DynamoDB | 50 GB / day Online | 2.5 TB / day Offline | 900 TB / year | 9.0 PB / 10-year |
| **5. Socket & Connection**| Max TCP / File Descriptors | 5K Open Connections | 25K Open Connections | — | — |
