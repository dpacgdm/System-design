...
Questions only. Covers Weeks 1-13 with emphasis on Distributed KV Store, Configuration Store, Kafka infrastructure. Attempt without opening answers.
...
**Q47 [W13 KV]**
What does a quorum KV store trade off with RF=3 R=2 W=2? Add the mechanism you would name in a Northstar incident.

**Q48 [W13 KV]**
Why are hinted handoff and read repair not a substitute for strong consistency? Add the evidence you would name in a Northstar incident.

**Q49 [W13 KV]**
What is a hot key in a distributed KV store? Add the first mitigation you would name in a Northstar incident.

**Q50 [W13 Config]**
Why does a configuration store need watch backpressure? Add the bad fix you would name in a Northstar incident.

**Q51 [W13 Config]**
Why must config changes be versioned and rollbackable? Add the capacity check you would name in a Northstar incident.

**Q52 [W13 Kafka]**
Why is ISR shrink a durability signal? Add the durable guardrail you would name in a Northstar incident.

**Q53 [W13 Kafka]**
Why should control-plane metadata be protected from tenant workloads? Add the tenant/blast-radius check you would name in a Northstar incident.

**Q54 [W13 Infra]**
What is the split-brain prevention in a leader-based store? Add the recovery step you would name in a Northstar incident.

**Q55 [W13 Recovery]**
Why not rebalance partitions during peak overload? Add the alerting signal you would name in a Northstar incident.

**Q56 [W13 Ops]**
Which metric beats average broker CPU? Add the design invariant you would name in a Northstar incident.

**Q57 [W13 KV]**
What does a quorum KV store trade off with RF=3 R=2 W=2? Add the runbook owner you would name in a Northstar incident.

**Q58 [W13 KV]**
Why are hinted handoff and read repair not a substitute for strong consistency? Add the mechanism you would name in a Northstar incident.

**Q59 [W13 KV]**
What is a hot key in a distributed KV store? Add the evidence you would name in a Northstar incident.

**Q60 [W13 Config]**
Why does a configuration store need watch backpressure? Add the first mitigation you would name in a Northstar incident.

**Q61 [W13 Config]**
Why must config changes be versioned and rollbackable? Add the bad fix you would name in a Northstar incident.

**Q62 [W13 Kafka]**
Why is ISR shrink a durability signal? Add the capacity check you would name in a Northstar incident.

**Q63 [W13 Kafka]**
Why should control-plane metadata be protected from tenant workloads? Add the durable guardrail you would name in a Northstar incident.

**Q64 [W13 Infra]**
What is the split-brain prevention in a leader-based store? Add the tenant/blast-radius check you would name in a Northstar incident.

**Q65 [W13 Recovery]**
Why not rebalance partitions during peak overload? Add the recovery step you would name in a Northstar incident.

**Q66 [W13 Ops]**
Which metric beats average broker CPU? Add the alerting signal you would name in a Northstar incident.

**Q67 [W13 KV]**
What does a quorum KV store trade off with RF=3 R=2 W=2? Add the design invariant you would name in a Northstar incident.

**Q68 [W13 KV]**
Why are hinted handoff and read repair not a substitute for strong consistency? Add the runbook owner you would name in a Northstar incident.
...
## Part 2: Compound Ops Sim - Northstar Config Store and Kafka Control Plane Storm
...
Systems involved:
  ...
  - checkout config clients
  - seller analytics noisy tenant

Business event:
  A high-visibility launch exercises Distributed KV Store, Configuration Store, Kafka infrastructure under production traffic.
...
CURRENT-WEEK SIGNALS:
  config_watch_queue_depth: 2k -> 2.4M
  kv_leader_changes_5m: 0 -> 17
  kafka_isr_shrink_events: +92
  controller_event_queue_age_seconds: 3 -> 880
  checkout_clients_stale_config_percent: 37%
