...
Questions only. Covers Weeks 1-12 with emphasis on Google Search, Web Crawler, indexing, ranking, freshness. Attempt without opening answers.
...
**Q47 [W12 Crawler]**
Why do crawlers need politeness and per-host budgets? Add the mechanism you would name in a Northstar incident.

**Q48 [W12 Crawler]**
What is the URL canonicalization failure mode? Add the evidence you would name in a Northstar incident.

**Q49 [W12 Crawler]**
Why separate fetch frontier, parsing, and indexing pipelines? Add the first mitigation you would name in a Northstar incident.

**Q50 [W12 Search]**
What causes zero-result spikes after an analyzer change? Add the bad fix you would name in a Northstar incident.

**Q51 [W12 Search]**
Why are shard size and segment count operational SLOs? Add the capacity check you would name in a Northstar incident.

**Q52 [W12 Search]**
What is the difference between freshness lag and relevance regression? Add the durable guardrail you would name in a Northstar incident.

**Q53 [W12 Ranking]**
Why should ranking features be versioned? Add the tenant/blast-radius check you would name in a Northstar incident.

**Q54 [W12 Ops]**
Why not run full reindex into live index during peak? Add the recovery step you would name in a Northstar incident.

**Q55 [W12 Abuse]**
How can crawler traps consume capacity? Add the alerting signal you would name in a Northstar incident.

**Q56 [W12 Recovery]**
How do you recover after bad analyzer deploy? Add the design invariant you would name in a Northstar incident.

**Q57 [W12 Crawler]**
Why do crawlers need politeness and per-host budgets? Add the runbook owner you would name in a Northstar incident.

**Q58 [W12 Crawler]**
What is the URL canonicalization failure mode? Add the mechanism you would name in a Northstar incident.

**Q59 [W12 Crawler]**
Why separate fetch frontier, parsing, and indexing pipelines? Add the evidence you would name in a Northstar incident.

**Q60 [W12 Search]**
What causes zero-result spikes after an analyzer change? Add the first mitigation you would name in a Northstar incident.

**Q61 [W12 Search]**
Why are shard size and segment count operational SLOs? Add the bad fix you would name in a Northstar incident.

**Q62 [W12 Search]**
What is the difference between freshness lag and relevance regression? Add the capacity check you would name in a Northstar incident.

**Q63 [W12 Ranking]**
Why should ranking features be versioned? Add the durable guardrail you would name in a Northstar incident.

**Q64 [W12 Ops]**
Why not run full reindex into live index during peak? Add the tenant/blast-radius check you would name in a Northstar incident.

**Q65 [W12 Abuse]**
How can crawler traps consume capacity? Add the recovery step you would name in a Northstar incident.

**Q66 [W12 Recovery]**
How do you recover after bad analyzer deploy? Add the alerting signal you would name in a Northstar incident.

**Q67 [W12 Crawler]**
Why do crawlers need politeness and per-host budgets? Add the design invariant you would name in a Northstar incident.

**Q68 [W12 Crawler]**
What is the URL canonicalization failure mode? Add the runbook owner you would name in a Northstar incident.
...
## Part 2: Compound Ops Sim - Northstar Search Freshness and Crawler Trap Incident
...
Systems involved:
  - crawler frontier
  - fetchers and parser workers
  - OpenSearch catalog index
  - ranking feature pipeline
  - query serving and autocomplete

Business event:
  A high-visibility launch exercises Google Search, Web Crawler, indexing, ranking, freshness under production traffic.
...
CURRENT-WEEK SIGNALS:
  crawler_frontier_urls_pending: 40M -> 1.9B
  robots_denied_rate: 1% -> 18%
  search_zero_result_rate: 2% -> 31%
  indexing_lag_seconds_p99: 2400
  ranking_feature_null_rate: 0.3% -> 12%
