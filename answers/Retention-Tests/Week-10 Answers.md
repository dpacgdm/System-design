...
**A47 [W10 YouTube]**
- Prompt focus: Why separate video upload acceptance from transcoding completion? Add the mechanism you would name in a Northstar incident.
- Model answer: Upload durability and processing are different stages; async pipelines absorb heavy transcoding while users see processing state. Include the mechanism explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A48 [W10 YouTube]**
- Prompt focus: What happens if one viral video thumbnail key becomes globally hot? Add the evidence you would name in a Northstar incident.
- Model answer: Cache/CDN hot key overloads origin or one cache shard; replicate, tier cache, and prewarm popular assets. Include the evidence explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A49 [W10 YouTube]**
- Prompt focus: Why is idempotency needed in a transcoding workflow? Add the first mitigation you would name in a Northstar incident.
- Model answer: Workers retry segments/jobs; stable job/segment ids prevent duplicate outputs and inconsistent manifests. Include the first mitigation explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A50 [W10 YouTube]**
- Prompt focus: How do you choose between CDN purge and versioned URLs for media changes? Add the bad fix you would name in a Northstar incident.
- Model answer: Versioned immutable URLs avoid broad purge blast radius; purge is for urgent invalidation with bounded scope. Include the bad fix explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A51 [W10 Uber]**
- Prompt focus: Why does dispatch require fresh driver location rather than last-known location? Add the capacity check you would name in a Northstar incident.
- Model answer: Matching stale drivers creates impossible ETAs; enforce freshness TTL and heartbeat gating. Include the capacity check explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A52 [W10 Uber]**
- Prompt focus: What is the hot-cell problem in ride matching? Add the durable guardrail you would name in a Northstar incident.
- Model answer: Dense areas overload one geospatial cell; use adaptive H3/geohash resolution, sharding, and supply-aware caching. Include the durable guardrail explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A53 [W10 Uber]**
- Prompt focus: Why should price estimate and final charge have different correctness contracts? Add the tenant/blast-radius check you would name in a Northstar incident.
- Model answer: Estimate can be approximate/stale; final charge requires authoritative rules, auditability, and idempotent payment. Include the tenant/blast-radius check explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A54 [W10 Mobility]**
- Prompt focus: How do you degrade surge pricing safely during an incident? Add the recovery step you would name in a Northstar incident.
- Model answer: Freeze or cap surge rules, preserve final fare audit, and avoid stale/incorrect charges. Include the recovery step explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A55 [W10 Media]**
- Prompt focus: Which telemetry proves origin overload rather than CDN miss config? Add the alerting signal you would name in a Northstar incident.
- Model answer: Origin QPS, cache hit ratio by path, edge status, origin latency, and top cache keys. Include the alerting signal explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A56 [W10 Recovery]**
- Prompt focus: How do you drain a transcoding backlog without starving live playback? Add the design invariant you would name in a Northstar incident.
- Model answer: Prioritize playback/manifest serving, throttle batch jobs, shard queues by priority, and replay idempotently. Include the design invariant explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A57 [W10 YouTube]**
- Prompt focus: Why separate video upload acceptance from transcoding completion? Add the runbook owner you would name in a Northstar incident.
- Model answer: Upload durability and processing are different stages; async pipelines absorb heavy transcoding while users see processing state. Include the runbook owner explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A58 [W10 YouTube]**
- Prompt focus: What happens if one viral video thumbnail key becomes globally hot? Add the mechanism you would name in a Northstar incident.
- Model answer: Cache/CDN hot key overloads origin or one cache shard; replicate, tier cache, and prewarm popular assets. Include the mechanism explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A59 [W10 YouTube]**
- Prompt focus: Why is idempotency needed in a transcoding workflow? Add the evidence you would name in a Northstar incident.
- Model answer: Workers retry segments/jobs; stable job/segment ids prevent duplicate outputs and inconsistent manifests. Include the evidence explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A60 [W10 YouTube]**
- Prompt focus: How do you choose between CDN purge and versioned URLs for media changes? Add the first mitigation you would name in a Northstar incident.
- Model answer: Versioned immutable URLs avoid broad purge blast radius; purge is for urgent invalidation with bounded scope. Include the first mitigation explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A61 [W10 Uber]**
- Prompt focus: Why does dispatch require fresh driver location rather than last-known location? Add the bad fix you would name in a Northstar incident.
- Model answer: Matching stale drivers creates impossible ETAs; enforce freshness TTL and heartbeat gating. Include the bad fix explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A62 [W10 Uber]**
- Prompt focus: What is the hot-cell problem in ride matching? Add the capacity check you would name in a Northstar incident.
- Model answer: Dense areas overload one geospatial cell; use adaptive H3/geohash resolution, sharding, and supply-aware caching. Include the capacity check explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A63 [W10 Uber]**
- Prompt focus: Why should price estimate and final charge have different correctness contracts? Add the durable guardrail you would name in a Northstar incident.
- Model answer: Estimate can be approximate/stale; final charge requires authoritative rules, auditability, and idempotent payment. Include the durable guardrail explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A64 [W10 Mobility]**
- Prompt focus: How do you degrade surge pricing safely during an incident? Add the tenant/blast-radius check you would name in a Northstar incident.
- Model answer: Freeze or cap surge rules, preserve final fare audit, and avoid stale/incorrect charges. Include the tenant/blast-radius check explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A65 [W10 Media]**
- Prompt focus: Which telemetry proves origin overload rather than CDN miss config? Add the recovery step you would name in a Northstar incident.
- Model answer: Origin QPS, cache hit ratio by path, edge status, origin latency, and top cache keys. Include the recovery step explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A66 [W10 Recovery]**
- Prompt focus: How do you drain a transcoding backlog without starving live playback? Add the alerting signal you would name in a Northstar incident.
- Model answer: Prioritize playback/manifest serving, throttle batch jobs, shard queues by priority, and replay idempotently. Include the alerting signal explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A67 [W10 YouTube]**
- Prompt focus: Why separate video upload acceptance from transcoding completion? Add the design invariant you would name in a Northstar incident.
- Model answer: Upload durability and processing are different stages; async pipelines absorb heavy transcoding while users see processing state. Include the design invariant explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A68 [W10 YouTube]**
- Prompt focus: What happens if one viral video thumbnail key becomes globally hot? Add the runbook owner you would name in a Northstar incident.
- Model answer: Cache/CDN hot key overloads origin or one cache shard; replicate, tier cache, and prewarm popular assets. Include the runbook owner explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.
