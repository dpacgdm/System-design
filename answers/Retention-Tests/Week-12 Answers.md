...
**A47 [W12 Crawler]**
- Prompt focus: Why do crawlers need politeness and per-host budgets? Add the mechanism you would name in a Northstar incident.
- Model answer: They avoid overwhelming origins and getting blocked; frontier scheduling enforces host/domain fairness. Include the mechanism explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A48 [W12 Crawler]**
- Prompt focus: What is the URL canonicalization failure mode? Add the evidence you would name in a Northstar incident.
- Model answer: Duplicate crawling/indexing or missed pages due to inconsistent normalization of scheme, params, slash, and redirects. Include the evidence explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A49 [W12 Crawler]**
- Prompt focus: Why separate fetch frontier, parsing, and indexing pipelines? Add the first mitigation you would name in a Northstar incident.
- Model answer: Each has different bottlenecks and retry semantics; separation isolates failures and backpressure. Include the first mitigation explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A50 [W12 Search]**
- Prompt focus: What causes zero-result spikes after an analyzer change? Add the bad fix you would name in a Northstar incident.
- Model answer: Tokenization/synonym/stemming mismatch can make queries and docs incompatible; shadow compare before rollout. Include the bad fix explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A51 [W12 Search]**
- Prompt focus: Why are shard size and segment count operational SLOs? Add the capacity check you would name in a Northstar incident.
- Model answer: They determine recovery, merge pressure, query latency, and reindex safety. Include the capacity check explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A52 [W12 Search]**
- Prompt focus: What is the difference between freshness lag and relevance regression? Add the durable guardrail you would name in a Northstar incident.
- Model answer: Freshness lag means docs not indexed; relevance regression ranks wrong results despite indexed docs. Include the durable guardrail explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A53 [W12 Ranking]**
- Prompt focus: Why should ranking features be versioned? Add the tenant/blast-radius check you would name in a Northstar incident.
- Model answer: Online serving and offline training must agree; unversioned features cause skew and silent relevance drops. Include the tenant/blast-radius check explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A54 [W12 Ops]**
- Prompt focus: Why not run full reindex into live index during peak? Add the recovery step you would name in a Northstar incident.
- Model answer: It competes for heap, IO, refresh, and merge resources and can destabilize serving. Include the recovery step explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A55 [W12 Abuse]**
- Prompt focus: How can crawler traps consume capacity? Add the alerting signal you would name in a Northstar incident.
- Model answer: Infinite calendars/faceted URLs explode frontier; use canonical rules, budgets, and duplicate detection. Include the alerting signal explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A56 [W12 Recovery]**
- Prompt focus: How do you recover after bad analyzer deploy? Add the design invariant you would name in a Northstar incident.
- Model answer: Rollback alias/analyzer, stop live reindex, replay lagged docs into new index, and compare zero-result/relevance metrics. Include the design invariant explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A57 [W12 Crawler]**
- Prompt focus: Why do crawlers need politeness and per-host budgets? Add the runbook owner you would name in a Northstar incident.
- Model answer: They avoid overwhelming origins and getting blocked; frontier scheduling enforces host/domain fairness. Include the runbook owner explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A58 [W12 Crawler]**
- Prompt focus: What is the URL canonicalization failure mode? Add the mechanism you would name in a Northstar incident.
- Model answer: Duplicate crawling/indexing or missed pages due to inconsistent normalization of scheme, params, slash, and redirects. Include the mechanism explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A59 [W12 Crawler]**
- Prompt focus: Why separate fetch frontier, parsing, and indexing pipelines? Add the evidence you would name in a Northstar incident.
- Model answer: Each has different bottlenecks and retry semantics; separation isolates failures and backpressure. Include the evidence explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A60 [W12 Search]**
- Prompt focus: What causes zero-result spikes after an analyzer change? Add the first mitigation you would name in a Northstar incident.
- Model answer: Tokenization/synonym/stemming mismatch can make queries and docs incompatible; shadow compare before rollout. Include the first mitigation explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A61 [W12 Search]**
- Prompt focus: Why are shard size and segment count operational SLOs? Add the bad fix you would name in a Northstar incident.
- Model answer: They determine recovery, merge pressure, query latency, and reindex safety. Include the bad fix explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A62 [W12 Search]**
- Prompt focus: What is the difference between freshness lag and relevance regression? Add the capacity check you would name in a Northstar incident.
- Model answer: Freshness lag means docs not indexed; relevance regression ranks wrong results despite indexed docs. Include the capacity check explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A63 [W12 Ranking]**
- Prompt focus: Why should ranking features be versioned? Add the durable guardrail you would name in a Northstar incident.
- Model answer: Online serving and offline training must agree; unversioned features cause skew and silent relevance drops. Include the durable guardrail explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A64 [W12 Ops]**
- Prompt focus: Why not run full reindex into live index during peak? Add the tenant/blast-radius check you would name in a Northstar incident.
- Model answer: It competes for heap, IO, refresh, and merge resources and can destabilize serving. Include the tenant/blast-radius check explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A65 [W12 Abuse]**
- Prompt focus: How can crawler traps consume capacity? Add the recovery step you would name in a Northstar incident.
- Model answer: Infinite calendars/faceted URLs explode frontier; use canonical rules, budgets, and duplicate detection. Include the recovery step explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A66 [W12 Recovery]**
- Prompt focus: How do you recover after bad analyzer deploy? Add the alerting signal you would name in a Northstar incident.
- Model answer: Rollback alias/analyzer, stop live reindex, replay lagged docs into new index, and compare zero-result/relevance metrics. Include the alerting signal explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A67 [W12 Crawler]**
- Prompt focus: Why do crawlers need politeness and per-host budgets? Add the design invariant you would name in a Northstar incident.
- Model answer: They avoid overwhelming origins and getting blocked; frontier scheduling enforces host/domain fairness. Include the design invariant explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.

**A68 [W12 Crawler]**
- Prompt focus: What is the URL canonicalization failure mode? Add the runbook owner you would name in a Northstar incident.
- Model answer: Duplicate crawling/indexing or missed pages due to inconsistent normalization of scheme, params, slash, and redirects. Include the runbook owner explicitly and tie it to a metric or invariant.
- Must include: layer/mechanism, evidence signal, protected invariant, and one rejected bad fix.
