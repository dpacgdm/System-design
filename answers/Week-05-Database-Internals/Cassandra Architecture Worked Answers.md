# Answer Key — Cassandra Architecture Worked Answers

> Open only after attempting the learner file questions.

# Worked Answers — Cassandra Architecture

Companion to [Cassandra Architecture](../../Week-05-Database-Internals/Cassandra%20Architecture.md) and [Retention Test Week 5](../../Retention-Tests/Week-05.md).
